    ...
    <ul class="flex items-center gap-3 justify-evenly p-5 relative z-10">
        <li>
            <a href="{{ route('front.index') }}">
                <div class="group flex flex-col items-center text-center gap-2 transition-all duration-300 hover:text-black {{ $bottom_nav == 'home' ? '' : 'text-[#9D9DAD]' }}">
                    ...
                    <p class="font-semibold text-sm leading-[21px] text-[]">Home</p>
                </div>
            </a>
        </li>
        <li>
            <a href="{{ route('front.transactions') }}">
                <div class="group flex flex-col items-center text-center gap-2 transition-all duration-300 hover:text-black {{ $bottom_nav == 'order' ? '' : 'text-[#9D9DAD]' }}">
                    <div class="w-6 h-6 flex shrink-0">
                        <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <li>
            <a href="">
                <div class="group flex flex-col items-center text-center gap-2 transition-all duration-300 hover:text-black {{ $bottom_nav == 'promo' ? '' : 'text-[#9D9DAD]' }}">
                    <div class="w-6 h-6 flex shrink-0">
                        <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
